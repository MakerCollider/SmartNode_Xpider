<script type="text/x-red" data-template-name="dataOut">
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span data-i18n="dataOut.label.name"></span></label>
        <input type="text" id="node-input-name" data-i18n="[placeholder]dataOut.label.placeholder">
    </div>
    <div class="form-row" style="margin-bottom:0;">
        <label><i class="fa fa-list"></i> <span data-i18n="dataOut.label.rules"></span></label>
    </div>
    ...
    <div class="form-row">
        <a href="#" class="editor-button editor-button-small" id="node-input-add-in-rule" style="margin-top: 4px;"><i class="fa fa-plus"></i> <span data-i18n="dataOut.label.addbutton"></span></a>
    </div>
    <div class="form-row">
        <label for="node-input-outkey"><i class="fa fa-sign-out"></i> <span data-i18n="dataOut.label.outkey"></span></label>
...
<script type="text/javascript">
    RED.nodes.registerType('dataOut', {
        ...
        icon: "light.png",
        label: function() {
            return this.name|| this._("dataOut.label.palette");
        },
        ...
        oneditprepare: function() {
            function generateInRule(i,rule) {
                ...
                $('<div/>',{style:"display:inline-block; width: 50px; text-align: right;"}).text("").appendTo(row);
