module.exports = function(RED) {
    ...
    function dataOutNode(config) {
        ...
        this.on('input', function (msg){
            ...
            for (var i=0; i<node.inRules.length; i++) {
                if (node.inRules[i].hasOwnProperty("name") && input[node.inRules[i].name] != null){
    ...
    RED.nodes.registerType("dataOut", dataOutNode);
}
