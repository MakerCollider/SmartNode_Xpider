...
<script type="text/x-red" data-template-name="dataIn">
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span data-i18n="dataIn.label.name"></span></label>
        <input type="text" id="node-input-name" data-i18n="[placeholder]dataIn.label.placeholder">
    </div>
    <div class="form-row" style="margin-bottom:0;">
        <label><i class="fa fa-list"></i> <span data-i18n="dataIn.label.rules"></span></label>
    </div>
    ...
    <div class="form-row">
        <a href="#" class="editor-button editor-button-small" id="node-input-add-in-rule" style="margin-top: 4px;"><i class="fa fa-plus"></i> <span data-i18n="dataIn.label.addbutton"></span></a>
    </div>
    <div class="form-row">
        <label for="node-input-outkey"><i class="fa fa-sign-in"></i> <span data-i18n="dataIn.label.outkey"></span></label>
...
<script type="text/javascript">
    RED.nodes.registerType('dataIn', {
        ...
        icon: "light.png",
        label: function() {
            return this.name|| this._("dataIn.label.palette");
        },
