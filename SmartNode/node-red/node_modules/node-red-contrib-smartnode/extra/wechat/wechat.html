...
<script type="text/javascript">
    RED.nodes.registerType('wechat in', {
        ...
        defaults: {
            ...
            prev_accountid: {value: "", required: false}
        },
        inputs: 0,
        outputs: 1,
        icon: "wechat.png",
        label: function() {
            return this.name || this._("wechat.label.palette-in");
        },
        paletteLabel: function () {
            return this._("wechat.label.palette-in");
        },
        oneditsave: function() {
        	this.prev_accountid = this.accountid;
        }
    });
</script>
...
<script type="text/javascript">
    RED.nodes.registerType('wechat out', {
        ...
        align: "right",
        label: function() {
            return this.name || "wechat out";
        },

        paletteLabel: function () {
            return  this._("wechat.label.palette-out");
        },
        oneditsave: function() {
          this.prev_accountid = this.accountid;
        }
