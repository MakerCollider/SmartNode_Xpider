...
<script type="text/x-red" data-template-name="Sound">
    ...
    <div class="form-row">
      <label for="node-input-analogPin"><i class="fa fa-tag"></i> Analog Pin</label>
...
/*******************Edit*******************/
  RED.nodes.registerType('Sound',{
      ...
      icon: "light.png",
      label: function() {
          return (this.name || this._("Sound.label.palette")) + ' A' + this.analogPin;
      },
      paletteLabel: function () {
          return this._("Sound.label.palette");
      },
      /***do not delete***/
