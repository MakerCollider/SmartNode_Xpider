...
<!-- Edit -->
<script type="text/x-red" data-template-name="Moisture">
    <div class="form-row">
    ...
    <div class="form-row">
      <label for="node-input-digitalPin"><i class="fa fa-tag"></i> Analog Pin</label>
...
/*******************Edit*******************/
  RED.nodes.registerType('Moisture',{
      category: 'Sensor',
      color: '#1b1e23',
      defaults: {
        board: {type:"nodebot", required:true},       //do not delete
        name: {value: ""},
        analogPin: {value: "2", required: false}
      },
      inputs: 0,
      outputs: 1,
      icon: "light.png",
      label: function() {
          return (this.name || this._("Moisture.label.palette")) + ' A' + this.analogPin;
      },
      paletteLabel: function () {
          return this._("Moisture.label.palette");
      },
      /***do not delete***/
