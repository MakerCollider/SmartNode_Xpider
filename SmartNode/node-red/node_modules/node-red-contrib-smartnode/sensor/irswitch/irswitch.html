...
<!-- Edit -->
<script type="text/x-red" data-template-name="IRSwitch">
    <div class="form-row">
    ...
    <div class="form-row">
      <label for="node-input-digitalPin"><i class="fa fa-tag"></i> Digital Pin</label>
      <!--input type="number" id="node-input-digitalPin"-->
      <select id="node-input-digitalPin">
          ...
          <option value=14>14(A0)</option>
          <option value=15>15(A1)</option>
          <option value=16>16(A2)</option>
          <option value=17>17(A3)</option>
          <option value=18>18(A4)</option>
          <option value=19>19(A5)</option>
      </select>
    </div>

    <div class="form-row">
      <label for="node-input-impulse"><i class="fa fa-tag"></i> Impulse</label>
      <input type="number" id="node-input-impulse">
    </div>
</script>
<!-- Edit -->
...
<script type="text/x-red" data-template-name="nodebot">
  ...
  <div class="form-row" id="node-div-firmataRow">
    ...
    <div class="form-row" id="node-div-socketServerRow">
      <label for="node-config-input-socketServer"><i class="fa fa-globe"></i>Websocket Server</label>
      <input type="text" id="node-config-input-socketServer" placeholder="wss://my_socket_server">
    </div>
    <div class="form-row" id="node-div-meshbluServerRow">
      <label for="node-config-input-meshbluServer"><i class="fa fa-globe"></i>Meshblu Server</label>
      <input type="text" id="node-config-input-meshbluServer" placeholder="https://meshblu.octoblu.com">
    </div>
...
/*******************Edit*******************/
  RED.nodes.registerType('IRSwitch',{
      category: 'Sensor',
      color: '#1b1e23',
      defaults: {
        board: {type:"nodebot", required:true},       //do not delete
        name: {value: ""},
        digitalPin: {value: "2", required: false},
      },
      inputs:0,
      outputs:1,
      icon: "light.png",
      label: function() {
          return (this.name || this._("IRSwitch.label.palette")) + ' D' + this.digitalPin;
      },
      paletteLabel: function () {
          return this._("IRSwitch.label.palette");
      },
      /***do not delete***/
