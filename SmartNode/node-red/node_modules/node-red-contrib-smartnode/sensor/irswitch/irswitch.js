    ...
    function IRSwitch(n) {
        ...
        if (typeof this.nodebot === "object") {
            ...
            node.nodebot.on("ioready", function () {
                ...
                /*******************Edit*******************/
                var irSwitch = new five.Pin(n.digitalPin);
                irSwitch.read(function(error, value) {
                    if(value === 1) {
                        node.status({fill: "green", shape: "dot", text: "nothing"});
                    } else {
                        node.status({fill: "red", shape: "dot", text: "Oops!"});
                    }
                    
                    node.send({payload: value, topic: "switch"});
                });
                /*******************Edit*******************/
