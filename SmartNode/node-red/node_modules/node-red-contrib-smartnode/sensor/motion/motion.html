...
<!-- Edit -->
<script type="text/x-red" data-template-name="Motion">
    <div class="form-row">
...
/*******************Edit*******************/
  RED.nodes.registerType('Motion',{
      category: 'Sensor',
      color: '#1b1e23',
      defaults: {
        board: {type:"nodebot", required:true},       //do not delete
        name: {value: ""},
        digitalPin: {value: "7", required: false}
      },
      inputs: 0,
      outputs: 1,
      icon: "light.png",
      label: function() {
          return (this.name || this._("Motion.label.palette")) + ' D' + this.digitalPin;
      },
      paletteLabel: function () {
          return this._("Motion.label.palette");
      },
      /***do not delete***/
