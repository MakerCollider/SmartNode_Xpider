...
<script type="text/x-red" data-template-name="Servo">
    ...
    <div class="form-row">
      <label for="node-input-startAt"><i class="fa fa-tag"></i> StartAt </label>
...
/*******************Edit*******************/
  RED.nodes.registerType('Servo',{
      ...
      defaults: {
        ...
        startAt: {value: 90, required: false}
      },
      inputs: 1,
      outputs: 0,
      icon: "light.png",
      align: "right",
      label: function() {
          return (this.name || this._("Servo.label.palette")) + ' PWM' + this.pwmPin;
      },
      paletteLabel: function () {
          return this._("Servo.label.palette");
      },
      /***do not delete***/
