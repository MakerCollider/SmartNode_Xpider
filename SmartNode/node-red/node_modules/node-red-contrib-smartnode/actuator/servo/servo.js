        ...
        if (typeof this.nodebot === "object") {
            ...
            node.nodebot.on("ioready", function () {
                ...
                node.on('input', function(msg){
                    var degree = Number(msg.payload);
                    if(degree >= 0 && degree <= 180) {
                        node.status({fill: "green", shape: "dot", text: "Degree: " + degree});
                        vServo.to(degree);
                    } else {
                        node.status({fill: "red", shape: "dot", text: "Input degree error"});
                    }
                });
                /*******************Edit*******************/
